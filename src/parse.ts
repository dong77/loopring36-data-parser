...
import { BlockContext, TransactionType } from './types'
...
const testAccountPrivKey =
  '80fc4b4b75850d8c0958b341bb8eae1f79819a00902d3744aa02eb8c7b9cb190'
const infuraUrlMain =
...
function processBlock(block: any) {
  ...
  for (let i = 0; i < block.blockSize; i++) {
    ...
    if (txType === TransactionType.NOOP) {
      ...
      console.log(
        'unknown transaction type: ' + txType,
        '; txData:',
        txData.getData()
      )
    }
